    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/iap/verify").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/generations/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/history", "/api/credits/balance", "/api/credits/ledger").authenticated()
